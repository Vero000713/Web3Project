...
function getTransactionQueryOptions(config, options = {}) {
  ...
  return {
    ...options.query,
    enabled: Boolean((options.hash || options.index && (options.blockHash || options.blockNumber || options.blockTag)) && (((_a = options.query) == null ? void 0 : _a.enabled) ?? true)),
    queryFn: async (context) => {
      const [, { scopeKey: _, ...parameters }] = context.queryKey;
...
function prepareTransactionRequestQueryOptions(config, options = {}) {
  ...
  return {
    ...options.query,
    enabled: Boolean(options.to && (((_a = options.query) == null ? void 0 : _a.enabled) ?? true)),
    queryFn: async (context) => {
      const [, { scopeKey: _, ...parameters }] = context.queryKey;
      if (!parameters.to)
