import {
  ...
  injected,
  mock
} from "./chunk-LXFIFJ6P.js";
import {
  withRetry,
  withTimeout
} from "./chunk-7WSZJL3H.js";
import "./chunk-PQGIRO5I.js";
import "./chunk-6O7JQSWI.js";
import "./chunk-NLSX6P6S.js";
import {
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await (() => {
          try {
            return import("./connectors-7Y55OXVV.js");
          } catch {
    ...
    async getProvider() {
      if (!walletProvider) {
        const { createCoinbaseWalletSDK } = await (() => {
          try {
            return import("./connectors-MZP6XANX.js");
          } catch {
      ...
      if (!metamask) {
        if (!metamaskPromise) {
          const { createEVMClient } = await (async () => {
            try {
              return import("./connectors-5A2HLNIO.js");
            } catch {
        ...
        try {
          if (!(accounts == null ? void 0 : accounts.length) && !isReconnecting) {
            const { RpcSchema } = await (() => {
              try {
                return import("./connectors-V5FGSIHF.js");
              } catch {
            ...
            const { z } = await (() => {
              try {
                return import("./connectors-EBW7UZLC.js");
              } catch {
    ...
    async getProvider() {
      ...
      if (!provider_) {
        const { default: SDK } = await (() => {
          try {
            return import("./connectors-QLR6E4H7.js");
          } catch {
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await (() => {
            try {
              return import("./connectors-KXT264DF.js");
            } catch {
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        const { EthereumProvider } = await (() => {
          try {
            return import("./connectors-SCK2HWJH.js");
          } catch {
