...
function getBlobBaseFee2(config, parameters = {}) {
  const { chainId } = parameters;
  const client = config.getClient({ chainId });
  const action = getAction(client, getBlobBaseFee, "getBlobBaseFee");
  return action({});
}
...
async function getContractEvents2(config, parameters) {
  const { chainId, ...rest } = parameters;
  const client = config.getClient({ chainId });
  const action = getAction(client, getContractEvents, "getContractEvents");
  return action(rest);
}
...
async function writeContractSync2(config, parameters) {
  ...
  const action = getAction(client, writeContractSync, "writeContractSync");
...
export {
  ...
  getBlobBaseFee2 as getBlobBaseFee,
  ...
  signTransaction2 as signTransaction,
  ...
  writeContractSync2 as writeContractSync,
  createConnector,
  injected,
  mock,
  deserialize,
...
//# sourceMappingURL=chunk-LXFIFJ6P.js.map
